...
/***/ 0:
/*!****************************************!*\
  !*** ./app/entry_points/components.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {

	'use strict';
	
	__webpack_require__(/*! ../frontend/react_components/mealsBox.jsx */ 176);
	__webpack_require__(/*! ../frontend/react_components/meal.jsx */ 36);
...
/***/ 36:
/*!************************************************!*\
  !*** ./app/frontend/react_components/meal.jsx ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(/*! underscore */ 37);
	var $ = __webpack_require__(/*! jquery */ 35);
	...
	var Meal = React.createClass({
	  ...
	  getDefaultPrice: function getDefaultPrice() {
	  ...
	  getNextPricePeople: function getNextPricePeople() {
	    var people = this.props.people;
	  ...
	  getBestPricePeople: function getBestPricePeople() {
	    var people = this.props.people;
	    var prices = this.props.prices;
	  ...
	  addOrder: function addOrder() {
	    ...
	    $.ajax({
	      ...
	      error: function error(data) {
	        _this.setState({ orders: _this.state.orders - 1 });
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'col-md-6 col-lg-4 meal' },
	      React.createElement(
	        'div',
	        { className: 'thumbnail' },
	        React.createElement('img', { src: 'images/meals/' + this.props.image, alt: 'Meal Picture' }),
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            null,
	            'Price ',
	            defaultPrice != currentPrice && React.createElement(
	              'span',
	              { className: 'lateral-space' },
	              React.createElement(
	                'strike',
	                null,
	                '$' + defaultPrice
	            ...
	            React.createElement(
	              'span',
	              { className: 'label-success current-price pull-right' },
	              '$' + currentPrice
	            )
	          ),
	          React.createElement('hr', null),
	          currentPrice == bestPricePeople.price ? React.createElement(
	            'p',
	            null,
	            ...
	            'If',
	            " ",
	            nextPricePeople.people - this.state.orders,
	            ' more people buy it, you will pay $',
	            nextPricePeople.price,
	            React.createElement('br', null),
	            ' Best deal:',
	            " ",
	            bestPricePeople.people,
	            ' people,',
	            " ",
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'a',
	              { className: 'btn btn-primary btn-outline', role: 'button', onClick: this.addOrder },
	              'Order'
	            )
	          )
	        )
...
/***/ 176:
/*!****************************************************!*\
  !*** ./app/frontend/react_components/mealsBox.jsx ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 2);
	var $ = __webpack_require__(/*! jquery */ 35);
	var Meal = __webpack_require__(/*! ./meal.jsx */ 36);
	var _ = __webpack_require__(/*! underscore */ 37);
	
	var MealsBox = React.createClass({
	  displayName: 'MealsBox',
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      _.map(this.state.restaurants, function (restaurant) {
	        return React.createElement(
	          'div',
	          { className: 'row', key: restaurant._id },
	          React.createElement(
	            'div',
