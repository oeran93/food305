...
var Meal = React.createClass({
	...
	render: function() {
		...
		return (
			<div className="col-xs-12 col-sm-6 col-md-4 meal">
		        			...
		        			?
			        			<p>
			        				...
			        				<span className='badge'>
			        					{this.state.orders}
			        				</span> people bought it
			        			</p>
			        			
			        		:
			        			<p>
			        				If {nextPricePeople.people - this.state.orders} more people buy it, 
			        				you will pay ${nextPricePeople.price}
			        				<br/>
			        				Best deal: {bestPricePeople.people} people, {'$'+bestPricePeople.price}
			        				<br/>
			        				<span className='badge'>
			        					{this.state.orders}
			        				</span> people bought it
